...
## Project Structure
    ...
    ├── test_user_flag_cont_43350  # Django project configurations
...
1. Clone this repo and `cd test_user_flag_cont_43350`
...
2. Clone this repo and `cd test_user_flag_cont_43350`
